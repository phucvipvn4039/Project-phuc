...
public class formQuizNormal extends AppCompatActivity {
private TextView Cauhoi, Ketqua, timer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SoundBackground = MediaPlayer.create(formQuizNormal.this, R.raw.wakawaka);
        ...
        BT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pos >= L.size()) {
                    Intent intent = new Intent(formQuizNormal.this, formResult.class);
    ...
    public void ReadData(String muc) {
        DatabaseOne databaseOne = new DatabaseOne(this);
        List<Question> Q = databaseOne.getQuestion(muc);
